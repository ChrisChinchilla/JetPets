...
?>
    <div class="htmlmail-body">
        Congratulation <?php echo $params['name'] ?>!! Your <?php echo $params['petName'] ?> is
        a <?php echo $params['petType'][0] ?>.<br>
        <br>
        <?php
        $config = array(
            "style_name" => "300px_shareable",
            "path" => $params['petImages'][0],
            "height" => NULL,
            "width" => NULL,
        );
        ...
        <br>
        You can download the certificate from this link to print out and frame.<br>
        <br>
        Find out how <?php echo $params['petName'] ?> compares to other pets by going here.<br>
        <br>
